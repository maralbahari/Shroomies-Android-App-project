...
//
//public class FavAptRecyclerAdapter extends RecyclerView.Adapter <FavAptRecyclerAdapter.favAptViewHolder>{
...
//    @NonNull
//    @Override
//    public favAptViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
//        LayoutInflater layoutInflater = LayoutInflater.from(context);
//        View view  = layoutInflater.inflate(R.layout.apartment_card,parent,false);
//        rootRef= FirebaseDatabase.getInstance().getReference();
//        return new favAptViewHolder(view);
//    }
//
//    @Override
//    public void onBindViewHolder(@NonNull final favAptViewHolder holder, final int position) {
//
...
//    }
//
//    class favAptViewHolder extends RecyclerView.ViewHolder{
//
//        TextView priceTV ;
...
//
//
//        public favAptViewHolder(@NonNull View itemView) {
//            super(itemView);
