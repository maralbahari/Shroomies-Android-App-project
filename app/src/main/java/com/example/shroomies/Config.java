...
//    public static final String URL_REMOVE_MEMBER= "http://10.0.2.2:5001/shroomies-e34d3/us-central1/removeMember";
    ...
    public static final String URL_ADD_TASK_CARDS = "https://us-central1-shroomies-e34d3.cloudfunctions.net/addTasksCards";
    public static final String URL_GET_APARTMENT_DETAILS = "https://us-central1-shroomies-e34d3.cloudfunctions.net/getApartmentDetails";
    public static final String FUNCTION_GET_MEMBER_DETAIL = "https://us-central1-shroomies-e34d3.cloudfunctions.net/getMembersDetails";
    public static final String FUNCTION_LEAVE_APARTMENT = "https://us-central1-shroomies-e34d3.cloudfunctions.net/leaveApartment";
    public static final String FUNCTION_DELETE_EXPENSE_CARD = "https://us-central1-shroomies-e34d3.cloudfunctions.net/deleteExpensesCard";
    public static final String FUNCTION_DELETE_TASK_CARD = "https://us-central1-shroomies-e34d3.cloudfunctions.net/deleteTasksCard";
    public static final String FUNCTION_ARCHIVE_TASKS_CARD = "https://us-central1-shroomies-e34d3.cloudfunctions.net/archiveTasksCard";
    public static final String FUNCTION_ARCHIVE_EXPENSES_CARD = "https://us-central1-shroomies-e34d3.cloudfunctions.net/archiveExpensesCard";
    public static final String FUNCTION_MARK_EXPENSES_CARD = "https://us-central1-shroomies-e34d3.cloudfunctions.net/markingExpensesCard";
    public static final String FUNCTION_MARK_TASK_CARD = "https://us-central1-shroomies-e34d3.cloudfunctions.net/markingTaskCard";
    public static final String FUNCTION_GET_ARCHIVE = "https://us-central1-shroomies-e34d3.cloudfunctions.net/getArchivedCard";
    public static final String FUNCTION_SEARCH_USERS = "https://us-central1-shroomies-e34d3.cloudfunctions.net/searchUserName";
    public static final String FUNCTION_DELETE_TASK_CARD_ARCHIVE = "https://us-central1-shroomies-e34d3.cloudfunctions.net/deleteArchiveTasksCard";
    public static final String FUNCTION_DELETE_EXPENSE_CARD_ARCHIVE = "https://us-central1-shroomies-e34d3.cloudfunctions.net/deleteArchiveExpensesCard";
