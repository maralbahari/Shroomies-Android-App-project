...
public class PersonalPostMapDialogFragment extends DialogFragment {
    private View v;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        if (bundle != null) {
            List<PersonalPostModel> personalPostModels = bundle.getParcelableArrayList(Config.PERSONAL_POST_LIST);
            if (personalPostModels != null) {
                PersonalPostMapAdapter mapSearchAdapter = new PersonalPostMapAdapter(getActivity(), personalPostModels);
